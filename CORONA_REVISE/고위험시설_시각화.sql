...
| FIELDS DATE, count as 당일 확진자 수, 수원시 예방접종 현황_REFERENCEDATE as REFERENCEDATE, 수원시 예방접종 현황_접종수요 as 접종수요, 수원시 예방접종 현황_1차접종완료 as 1차 접종자 수, 수원시 예방접종 현황_2차접종완료 as 2차 접종자 수
